...
Filter.prototype.serialize = function(data, headers, route, ip, agent, cookies, callback) {
  ...
  obj.ip = Ip; //crypto.pbkdf2Sync(Ip, this.config.key, 3, 30).toString("hex");
  ...
  obj.ts = (obj.rt && obj.rt.tstart) || (obj.nt && obj.nt.nav && obj.nt.nav.st) || obj.created.getTime();
